      ...
      <div className="flex-1 overflow-y-auto px-4 pt-4 pb-2">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center text-gray-400">
            ...
            <p className="text-sm font-medium text-gray-600 mb-2">美食小幫手</p>
            ...
            <div className="mt-4 space-y-2">
              <button
                ...
                className="block w-full text-xs bg-gray-100 hover:bg-indigo-50 text-gray-600 hover:text-indigo-600 rounded-lg px-3 py-2 transition-colors"
              >
      ...
      <div className="border-t border-gray-200 bg-white px-4 py-3">
        <div className="flex items-end gap-2">
          <textarea
            ...
            placeholder="輸入訊息..."
            rows={1}
            className="flex-1 resize-none border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent max-h-[120px]"
            aria-label="聊天輸入框"
          />
          <button
            type="button"
        ...
        <p className="text-[10px] text-gray-400 mt-1.5 text-center">Shift+Enter 換行，Enter 發送</p>
      </div>
    </div>
  );
}
